...
export default function HeroSection() {
    return <div className="text-white flex-center flex-col">
              <div id="heading" className="flex flex-col items-center p-1 gap-9 mt-20 mb:mt-12">
                ...
                <p className="text-center tb:text-sm text-[#606060] p-1">Empower your creativity and bring your VR app ideas to life with our intuitive development tools. <br />
