...
export default function Pricing() { 
    ...
    return <main className="flex flex-col items-center p-1 gap-1">
             <span className="text-white text-6xl tb:text-5xl mb:text-4xl mt-14 mb:mt-7 mb-7">Pricing</span>
             <div id="cards" className="flex mb:flex-wrap p-1 gap-3 tb:gap-1 justify-center w-[70%] tb:w-full mb:w-[85%]">
...
function Card({title, price, features}){
    return <div className="flex flex-col basis-1/3 mb:grow p-8 tb:p-5 gap-5 tb:gap-3 mb:gap-2 text-white rounded-lg border border-[#514848]">
